...
function settingtoggle_mobile() {
  document
  .getElementById("mobile-setting-container") // This is now the LI itself
  .classList.toggle("settingactivate-mobile");
document
  .getElementById("visualmodetogglebuttoncontainermobile")
  .classList.toggle("visualmodeshow-mobile");
document
  .getElementById("soundtogglebuttoncontainermobile")
  .classList.toggle("soundmodeshow-mobile");
}
function playpause() {
...
const sections = document.querySelectorAll("section"),
  navLi = document.querySelectorAll(".navbar .navbar-tabs-ul li"),
